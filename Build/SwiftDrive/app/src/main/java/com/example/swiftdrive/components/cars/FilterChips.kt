...
fun FilterChips(
    ...
    Row(
        ...
        // All Chip
        FilterChip(
            selected = selectedEngineTypes.isEmpty() && selectedConditions.isEmpty() &&
                    selectedCategories.isEmpty() && selectedTiers.isEmpty() && selectedAvailabilities.isEmpty(),
            onClick = onClearAll,
            label = { Text("All") }
        )
