...
fun AddCustomerScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            verticalArrangement =
                Arrangement.spacedBy(16.dp) // Adds space between each child composable.
        ) {
            // --- Form Input Fields ---
            OutlinedTextField(
            ...
            Column(
                ...
                Button(
                    onClick = {
                        val isValid = viewModel.onSaveCustomerClick()
...
fun InfoBox() {
    Row(
        ...
        Text(
            text =
                "Customer information is used for rental agreements and communication purposes.",
